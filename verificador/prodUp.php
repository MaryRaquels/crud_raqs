...
if(isset($_POST['submit'])) {
    if(isset($_POST['nome']) && !empty($_POST['nome']) && isset($_POST['validade']) && !empty($_POST['validade']) && isset($_POST['valor']) && !empty($_POST['valor']) && isset($_POST['quantidade']) && !empty($_POST['quantidade']) && isset($_POST['idprodutos']) && !empty($_POST['idprodutos'])){
        require '../conexao.php';
        $nome = $_POST['nome'];
